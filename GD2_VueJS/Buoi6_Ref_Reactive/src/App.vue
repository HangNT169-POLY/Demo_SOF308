...
<template>
  ...
  <!-- Khi lap trinh vs view thi lam viec vs reativity.
   1. Su dung ref.
   Trong compositation APi duoc khuyen khich su dung ref de khai bao state trong vue -->
  <!-- <h1>{{ count }}</h1> -->
  <!-- Ref khai bao state trong vue. Lay gia tri thong qua thuoc tinh .value -->
  <!-- Tai sao phai dung ref:
     1. Khi dùng ref trong template (chính là phần render ra).
     Sau đó nếu có sự thay đổi của ref thì view sẽ giúp các bạn tự động phát hiện thay đổi đó
     ...
     3. Cách vue làm là:
        ...
        Khi ref bị biến đổi thì vue sẽ theo dõi là cập nhật lại dom nếu ref thay đổi
      -->
  <h1>{{ count2 }}</h1>
